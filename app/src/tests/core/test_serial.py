...
from growzucchini.core.serial import ArduinoProtocol
...
@pytest.fixture
def mock_dispatcher():
    with patch("growzucchini.core.serial.controller_dispatcher") as mock:
        yield mock


@pytest.fixture
def mock_get_sensor_data():
    with patch("growzucchini.core.serial.get_sensor_data") as mock:
        yield mock
